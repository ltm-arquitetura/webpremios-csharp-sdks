...
namespace IO.Swagger.Models
{
    ...
    public partial class Address :  IEquatable<Address>
    {
        ...
        /// <param name="Reference">Ponto de referência.</param>
        public Address(string Street = default(string), string Number = default(string), string Complement = default(string), string District = default(string), string City = default(string), StateEnum? State = default(StateEnum?), string ZipCode = default(string), string Reference = default(string))
        {
            this.Street = Street;
            this.Number = Number;
        ...
        /// Ponto de referência
        /// </summary>
        /// <value>Ponto de referência</value>
