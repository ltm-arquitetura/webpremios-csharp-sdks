...
namespace IO.Swagger.Models
{
    ...
    public partial class Catalog :  IEquatable<Catalog>
    {
        ...
        /// </summary>
        /// <param name="Id">Identificador do catalogo.</param>
        /// <param name="Name">Nome do catalogo.</param>
        public Catalog(string Id = default(string), string Name = default(string))
        {
            this.Id = Id;
            this.Name = Name;
